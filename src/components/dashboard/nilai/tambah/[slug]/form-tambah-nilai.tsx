...
import { OptionSubKriteria } from "@/components/dashboard/nilai/tambah/[slug]/option-sub-kriteria";

export async function FormTambahNilai({
  id_alternatif,
}: {
  ...
  const createNilaiByIdAlternatif = createNilai.bind(null, id_alternatif);

  return (
    <form action={createNilaiByIdAlternatif}>
      ...
      <div className="md:flex md:items-center">
        ...
        <div className="md:w-2/3">
          <ButtonAction title="Simpan Nilai" />
        </div>
      </div>
    </form>
  );
