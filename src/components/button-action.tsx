...
export function ButtonAction({ title }: { title: string }) {
  ...
  return (
    <button
      ...
      } px-4 py-2 text-base font-medium leading-6 text-white hover:bg-emerald-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-400`}
      type="submit"
      disabled={pending}
    >
